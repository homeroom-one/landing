...
<template>
  {#if show}
    <div class="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div class="fixed inset-0 bg-midnight-500 bg-opacity-75 transition-opacity" in:fade={{ duration: time }} out:fade={{ duration: time }} />

      <div class="fixed inset-0 z-10 overflow-y-auto" in:fly={{ y: 50, duration: time, delay: time }} out:fly={{ duration: time }}>
          ...
          >
            <div>
              <div class="mt-3 sm:mt-5">
                <h3 class="text-2xl font-bold leading-10 text-gray-900" id="modal-title">Privacy Policy for HomeroomOne</h3>
                <div class="policy mt-2">
                  <p>
                    At HomeroomOne, accessible from https://homeroomone.com/, one of our main priorities is the privacy of our visitors. This Privacy Policy
                    document contains types of information that is collected and recorded by HomeroomOne and how we use it.
                  </p>
                  ...
                  <p>
                    ...
                    shared and/or collect in HomeroomOne. This policy is not applicable to any information collected offline or via channels other than this
                    website. Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info/"
                  ...
                  <p>
                    HomeroomOne follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do
                    this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser
                  ...
                  <p>
                    ...
                    the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads"
                  ...
                  <p>You may consult this list to find the Privacy Policy for each of the advertising partners of HomeroomOne.</p>
                  ...
                  <p>
                    ...
                    advertisements and links that appear on HomeroomOne, which are sent directly to users' browser. They automatically receive your IP address
                  ...
                  <p>Note that HomeroomOne has no access to or control over these cookies that are used by third-party advertisers.</p>

                  <h2>Third Party Privacy Policies</h2>

                  <p>
                    HomeroomOne's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy
                  ...
                  <p>
                    HomeroomOne does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child
